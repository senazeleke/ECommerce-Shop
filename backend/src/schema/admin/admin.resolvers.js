  ...
  Mutation: {
    ...
    resetPasswordAdmin: async (_, { token, password }) => {
      try {
        ...
        const userSession = await db.one(
          'SELECT * FROM user_sessions WHERE session_token = $1 OR expiration_time > to_timestamp($2) ORDER BY expiration_time ASC LIMIT 1',
        ...
        console.log("Password reset successful for admin_id:", userSession.user_id);
